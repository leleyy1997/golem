 ...
 * 根据剩余重量和总重量计算耗材状态
 */
export function calculateFilamentStatus(remaining, total, settings) {
 ...
 * 为耗材数组批量计算状态
 */
export function applyStatusToFilaments(filaments, settings) {
 ...
 * 生成新的耗材 ID
 */
export function generateFilamentId() {
